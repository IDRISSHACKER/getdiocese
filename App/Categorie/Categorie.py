...
class Categorie:
    def __init__(self, home):
        ...
        self.home = home
        self.addCtg = loadUi("ui/Categorie/newCategorie.ui")
    ...
    def settup_connexion(self):
        self.populateTable()
        self.home.ctgTable.selectionModel().selectionChanged.connect(self.onSelectedChanged)
        self.categorieState = 1
        self.home.addCtg.clicked.connect(self.showAddCtgModal)
    ...
    def initializeTable(self):
        self.home.ctgTable.setColumnCount(3)
        self.home.ctgTable.setHorizontalHeaderLabels(("Nom de la categorie", "Edition", "Supression"))
        self.home.ctgTable.setColumnWidth(0, 200)
        self.home.ctgTable.setColumnWidth(1, 200)
        self.home.ctgTable.setColumnWidth(2, 200)
    ...
    def populateTable(self):
        ...
        self.home.ctgTable.setRowCount(size)
        index = 0
        ...
        for data in datas:
            ...
            self.home.ctgTable.setCellWidget(index, 0, PyQt5.QtWidgets.QLabel(data[1]))
            self.home.ctgTable.setCellWidget(index, 1, editBtn)
            self.home.ctgTable.setCellWidget(index, 2, deleteBtn)
            index += 1

    def onSelectedChanged(self, selected, deselected):
        table = self.home.ctgTable
