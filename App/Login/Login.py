...
class Login:
    ...
    def modify_layout(self):
        ...
        self.login.connect.setGraphicsEffect(QtWidgets.QGraphicsDropShadowEffect(blurRadius=5, xOffset=2, yOffset=2, color=QtGui.QColor(0, 0,0, 10)))
    ...
    def connexion(self):
        ...
        if name == "idriss" or password == "1234":
            self.login.close()
            self.home.show()
        else:
